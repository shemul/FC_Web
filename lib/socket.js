...
socket.on('entrance', function(msg){
    ...
    for (var i = msg.length - 1; i >= 0; i--) {
        ...
        if(msg[i].f_status=="Available"){
          ...
          sticker='<span style ="background-color : #3dbec9 ; color:white;padding:5px">'+(msg[i].f_status).toUpperCase()+'</span>'; 
        }
...
socket.on('item', function(msg2){
    ...
    */
    ...
    if(msg2.msg.f_status=="Available"){
      ...
      sticker='<span style ="background-color : #3dbec9 ; color:white;padding:5px">'+(msg2.msg.f_status).toUpperCase()+'</span>'; 
    }
...
socket.on('update', function (data) {
  ...
  if(f_status == "Available") {
    ...
    $("div#"+id+" div.hbox-column.v-top > div > div.stick-top-right.small-padding").html('<span style ="background-color : #3dbec9 ; color:white;padding:5px">'+f_status.toUpperCase()+'</span>'); 
